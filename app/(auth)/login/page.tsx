...
export default function Login() {
  return (
    <main className="bg-backgroundMain h-screen overflow-hidden flex items-center justify-center">
      <section className="flex justify-between h-[80vh] w-[90vw] mt-14 relative">
        {/* Container1 */}
        <div className="bg-white h-full w-1/2 rounded-l-3xl">
          ...
          <div className="absolute bottom-0 left-0 bg-main h-[30vh] w-1/2 rounded-bl-3xl image"></div>
        </div>

        {/* Container 2 */}
        <div className="h-full w-1/2 relative border-y bg-main rounded-3xl flex justify-center items-center">
